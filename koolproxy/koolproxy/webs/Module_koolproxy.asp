...
function get_kp_status(){
	...
	$.ajax({
		...
		success: function(response) {
			...
			$("#kp_rule_7").html(kp_status.split("@@")[7])
...
function refresh_rule_table() {
	$.ajax({
		...
		success: function(response) {
			$.globalEval(response);
			dbus = db_koolproxy_;
			$("#rule_table").find("tr:gt(8):lt(-1)").remove();
			$('#rule_table tr:eq(8)').after(refresh_rule_html());
...
function save(){
	...
	if(E("koolproxy_rule_enable_d4").checked == true){
		sourceList += "1|easylistchina.txt|https://raw.githubusercontent.com/user1121114685/koolproxyR/master/koolproxyR/koolproxyR/data/rules/easylistchina.txt|easylistchina规则>"
	}else{
		sourceList += "0|easylistchina.txt|https://raw.githubusercontent.com/user1121114685/koolproxyR/master/koolproxyR/koolproxyR/data/rules/easylistchina.txt|easylistchina规则>"
	}
	if(E("koolproxy_rule_enable_d5").checked == true){
		sourceList += "1|fanboy-annoyance.txt|https://raw.githubusercontent.com/user1121114685/koolproxyR/master/koolproxyR/koolproxyR/data/rules/fanboy-annoyance.txt|fanboy-annoyance规则>"
	}else{
		sourceList += "0|fanboy-annoyance.txt|https://raw.githubusercontent.com/user1121114685/koolproxyR/master/koolproxyR/koolproxyR/data/rules/fanboy-annoyance.txt|fanboy-annoyance规则>"
	}
	if(E("koolproxy_rule_enable_d6").checked == true){
		sourceList += "1|kpr_video_list.txt|https://raw.githubusercontent.com/user1121114685/koolproxyR/master/koolproxyR/koolproxyR/data/rules/kpr_video_list.txt|kpr视频规则>"
	}else{
		sourceList += "0|kpr_video_list.txt|https://raw.githubusercontent.com/user1121114685/koolproxyR/master/koolproxyR/koolproxyR/data/rules/kpr_video_list.txt|kpr视频规则>"
	}
	if(E("koolproxy_rule_enable_d7").checked == true){
		sourceList += "1|yhosts.txt|https://raw.githubusercontent.com/user1121114685/koolproxyR/master/koolproxyR/koolproxyR/data/rules/yhosts.txt|yhosts规则>"
	}else{
		sourceList += "0|yhosts.txt|https://raw.githubusercontent.com/user1121114685/koolproxyR/master/koolproxyR/koolproxyR/data/rules/yhosts.txt|yhosts规则>"
	}
	maxid = parseInt($("#rule_table > tbody > tr:eq(-2) > td:nth-child(1) > input").attr("id").split("_")[3]);
	for ( var i = 1; i <= maxid; ++i ) {
		if (E("koolproxy_rule_enable_" + i)){
									...
									<td bgcolor="#4D595D" colspan="3" valign="top" style="border-radius: 8px">
										...
										<div id="rule_table_div" style="margin:10px 0px 0px 0px;width:748px">
											<table class="FormTable1" id="rule_table" style="margin:-1px 0px 0px 0px;border: 1px solid #000000;width:100%;" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" >
												...
												<tr>
													<td style="text-align:center;">
														<input type="checkbox" id="koolproxy_rule_enable_d5" checked="checked" name="koolproxy_rule_enable_d5" />
													</td>
													<td>
												...
												<tr>
													<td style="text-align:center;">
														<input type="checkbox" id="koolproxy_rule_enable_d6" checked="checked" name="koolproxy_rule_enable_d6" />
													</td>
													<td>
														kpr_video_list.txt
													</td>
													<td>
														https://raw.githubusercontent.com/user1121114685/koolproxyR/master/koolproxyR/koolproxyR/data/rules/kpr_video_list.txt
													</td>
													<td style="text-align:center;">
														kpr视频规则
													</td>
												...
												<tr>
													<td style="text-align:center;">
														<input type="checkbox" id="koolproxy_rule_enable_d7" checked="checked" name="koolproxy_rule_enable_d7" />
													</td>
													<td>
														yhosts.txt
													</td>
